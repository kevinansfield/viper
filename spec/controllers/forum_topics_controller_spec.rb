...
describe ForumTopicsController, "GET #index" do
  ...
  describe ForumTopicsController, "(xml)" do
    define_models :stubbed
...
describe ForumTopicsController, "GET #show" do
  define_models :stubbed
  ...
  describe ForumTopicsController, "(logged in)" do
    define_models :stubbed
...
describe ForumTopicsController, "GET #new" do
  define_models :stubbed
...
describe ForumTopicsController, "GET #edit" do
  define_models :stubbed
...
describe ForumTopicsController, "POST #create" do
  before do
    login_as :default
    @forum  = forums(:default)
    Forum.stub!(:find_by_permalink).with('1').and_return(@forum)
    @attributes = {}
    @topic = mock_model ForumTopic, :new_record? => false, :errors => []
    @user.stub!(:post_to_forum).with(@forum, @attributes).and_return(@topic)
  end
  
  describe ForumTopicsController, "(successful creation)" do
    define_models :stubbed
  ...
  describe ForumTopicsController, "(unsuccessful creation)" do
    define_models :stubbed
    act! { post :create, :forum_id => 1, :topic => @attributes }
  ...
  describe ForumTopicsController, "(successful creation, xml)" do
    define_models :stubbed
  ...
  describe ForumTopicsController, "(unsuccessful creation, xml)" do
    define_models :stubbed
    act! { post :create, :forum_id => 1, :topic => @attributes, :format => 'xml' }
...
describe ForumTopicsController, "PUT #update" do
  before do
    login_as :default
    @forum  = forums(:default)
    Forum.stub!(:find_by_permalink).with('1').and_return(@forum)
  ...
  describe ForumTopicsController, "(successful save)" do
    define_models :stubbed
  ...
  describe ForumTopicsController, "(unsuccessful save)" do
    define_models :stubbed
    act! { put :update, :forum_id => 1, :id => 1, :topic => @attributes }
  ...
  describe ForumTopicsController, "(successful save, xml)" do
    define_models :stubbed
  ...
  describe ForumTopicsController, "(unsuccessful save, xml)" do
    define_models :stubbed
    act! { put :update, :forum_id => 1, :id => 1, :topic => @attributes, :format => 'xml' }
...
describe ForumTopicsController, "DELETE #destroy" do
  define_models :stubbed
